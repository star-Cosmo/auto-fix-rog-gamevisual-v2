...
| 厂商 | EDID[8..11] | 计算出的 ID | 厂商代码 |
|---|---|---|---|
| 华星光电（CSOT · CSW 注册码）✓ 实机验证 | `0E 77 0F 15` | `770E150F` | `770E` |
| 京东方 | `09 E5 07 0A` | `E5090A07` | `E509` |
| LG Display（乐金显示，LGD） | `30 E4 63 05` | `E4300563` | `E430` |
| 友达光电（AUO） | `06 AF A2 D2` | `AF06D2A2` | `AF06` |
| 群创光电（Innolux） | `0D AE 3C 15` | `AE0D153C` | `AE0D` |
| 夏普（SHP） | `4D 10 59 15` | `104D1559` | `104D` |
| 天马（TMX） | `51 B8 61 15` | `B8511561` | `B851` |
| 华星光电（CSO 注册码） | `0E 6F 0F 15` | `6F0E150F` | `6F0E` |
...
> - 同一厂商在 EDID 里是 3 个字母（如夏普 SHP），在 ICC 文件名里是 4 位十六进制前缀（如 104D）。上表"厂商代码"列即文件名前缀——去 `color/` 找文件、认贡献的 icm 时，认这个前缀最快。
